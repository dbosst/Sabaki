...
const clock = isRenderer ? require('./modules/clock') : null
    ...
    let data = [
        ...
        },
        {
            ...
            submenu: [
                ...
                {type: 'separator'},
                {
                    label: t('menu.play', 'Pa&use/Resume Clock'),
                    click: () => sabaki.toggleClockPaused()
                },
                {
                    label: t('menu.play', '&Disable/Enable Clock'),
                    click: () => sabaki.toggleClockEnabled()
                },
                {
                    label: t('menu.play','Reset Cloc&k'),
            ...
            submenu: [
                ...
                },
                {
                    ...
                    click: () => {
                        ...
                        sabaki.setupClockForEngineMove()
        ...
        },
        {
            ...
            submenu: [
                ...
                {type: 'separator'},
                {
                    label: t('menu.tools', 'Adjust &Clock…'),
