    ...
    componentWillReceiveProps({gameInfo, engines, show}) {
        if (!this.props.show && show) {
            ...
            this.setState(Object.assign({}, gameInfo, {
                derivedTime: true,
                blackInfiniteTime: blackInfiniteTime,
                blackOvertime: blackOvertime,
                whiteEqualTime: whiteEqualTime,
                whiteInfiniteTime: whiteInfiniteTime,
                whiteOvertime: whiteOvertime,
                blackMainTimeHours: blackMainTimeHours,
                blackMainTimeMinutes: blackMainTimeMinutes,
                blackMainTimeSeconds: blackMainTimeSeconds,
                blackPeriodTimeMinutes: blackPeriodTimeMinutes,
                blackPeriodTimeSeconds: blackPeriodTimeSeconds,
                whiteMainTimeHours: whiteMainTimeHours,
                whiteMainTimeMinutes: whiteMainTimeMinutes,
                whiteMainTimeSeconds: whiteMainTimeSeconds,
                whitePeriodTimeMinutes: whitePeriodTimeMinutes,
                whitePeriodTimeSeconds: whitePeriodTimeSeconds,
                engines: [...engines],
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (changed) {
            this.setState({
                ...
                blackMainTimeMinutes: blackMainTimeMinutes,
                blackMainTimeSeconds: blackMainTimeSeconds,
                blackNumPeriods: blackNumPeriods,
                blackPeriodMoves: blackPeriodMoves,
                blackPeriodTime: blackPeriodTime,
                blackPeriodTimeMinutes: blackPeriodTimeMinutes,
                blackPeriodTimeSeconds: blackPeriodTimeSeconds,
                whiteInfiniteTime: whiteInfiniteTime,
                whiteOvertime: whiteOvertime,
                ...
                whiteMainTimeMinutes: whiteMainTimeMinutes,
                whiteMainTimeSeconds: whiteMainTimeSeconds,
                whiteNumPeriods: whiteNumPeriods,
                whitePeriodMoves: whitePeriodMoves,
                whitePeriodTime: whitePeriodTime,
                whitePeriodTimeMinutes: whitePeriodTimeMinutes,
                whitePeriodTimeSeconds: whitePeriodTimeSeconds
            })
        }
